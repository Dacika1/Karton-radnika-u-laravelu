<!-- forma create modal -->
<div class="modal fade myModal4" role="dialog">
<div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-header">
     ...
     <form class="form-horizontal" role="form" action="{{route('magistarske.update','test')}}" method="post">
      {{method_field('patch')}}
      {{csrf_field()}}
    <div class="modal-body">
      <input type="hidden" id="mag_id" name="mag_id">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          <label class="control-label col-sm-4" for="n">Назив магистарског рада:</label>
          <div class="col-sm-8">
