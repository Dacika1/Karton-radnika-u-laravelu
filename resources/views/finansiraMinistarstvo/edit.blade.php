<!-- forma create modal -->
     <div class="modal fade izmeni4" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
           ...
           <form class="form-horizontal" role="form" action="{{route('finansiraMinistarstvo.update','test')}}" method="post">
            {{method_field('patch')}}
            {{csrf_field()}}
          <div class="modal-body">
            <input type="hidden" id="fin_id" name="fin_id">
