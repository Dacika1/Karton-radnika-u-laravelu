...
<section class="wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h3 class="page-header"><i class="fa fa-briefcase"></i>Група резултата М90</h3>
    </div>
  </div>
<div class="row">
    <!-- profile-widget -->
    ...
    <section class="panel">
      <header class="panel-heading tab-bg-info">
        <ul class="nav nav-tabs">
          <li>
            <a href="#" data-toggle="modal" data-target="#sacuvaj8">
    ...
    <section class="panel">
     ...
     <table class="table table-striped table-advance table-hover" id="users-table">
        <tbody>
          ...
          @if($article->kljuc>=90 && $article->kljuc<=100)
          <tr>
            <td>{{$no++}}</td>
