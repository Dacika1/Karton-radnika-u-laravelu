...
<section class="wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h3 class="page-header"><i class="fa fa-book"></i>Група резултата М30</h3>
    </div>
  </div>
<div class="row">
    <!-- profile-widget -->
  ...
  <div class="col-lg-12">
    <section class="panel">
      <header class="panel-heading tab-bg-info">
        <ul class="nav nav-tabs">
          <li>
            <a href="#" data-toggle="modal" data-target="#sacuvaj3">
    ...
    <section class="panel">
      <div class="panel-body bio-graph-info" id="podaci">
        <h1>Зборници међународних научних скупова</h1>
     <table class="table table-striped table-advance table-hover" id="users-table">
        <tbody>
          ...
          @if($article->kljuc>30 && $article->kljuc<=40)
          <tr>
            <td>{{$no++}}</td>
