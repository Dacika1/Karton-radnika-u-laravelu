...
<section class="wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h3 class="page-header"><i class="fa fa-calendar-check-o"></i>Група резултата М80</h3>
    </div>
  </div>
<div class="row">
    <!-- profile-widget -->
    ...
    <section class="panel">
      <header class="panel-heading tab-bg-info">
        <ul class="nav nav-tabs">
          <li>
            <a href="#" data-toggle="modal" data-target="#sacuvaj7">
    ...
    <section class="panel">
     ...
     <table class="table table-striped table-advance table-hover" id="users-table">
        <tbody>
          ...
          @if($article->kljuc>=80 && $article->kljuc<=90)
           <tr>
            <td>{{$no++}}</td>
