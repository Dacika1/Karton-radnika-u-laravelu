<!-- forma create modal -->
<div class="modal fade myModal6" role="dialog">
<div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-header">
     ...
     <form class="form-horizontal" role="form" action="{{route('doktorske.update','test')}}" method="post">
      {{method_field('patch')}}
      {{csrf_field()}}
    <div class="modal-body">
      <input type="hidden" id="dokt_id" name="dokt_id">
        <div class="form-group">
          <label class="control-label col-sm-4" for="g">Датум одбране дисертације:</label>
          <div class="col-sm-8">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          <label class="control-label col-sm-4" for="n">Назив докторске дисертације:</label>
          <div class="col-sm-8">
        ...
        <div class="form-group">
          <label class="control-label col-sm-4" for="o">Област:</label>
          <div class="col-sm-8">
         ...
         <div class="form-group">
          <label class="control-label col-sm-4" for="s">Стечени научни назив:</label>
          <div class="col-sm-8">
