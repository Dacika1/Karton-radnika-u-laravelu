 <div id="sacuvaj9" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
       ...
       <h4 class="modal-title">Подаци о раду:</h4>
        ...
        <form class="form-horizontal" action="{{route('casopis8.store')}}" method="post">
            {{csrf_field()}}
        <div class="modal-body">
          ...
          <select name="spiU" id="spiU">
                 <option value="101" class="tooltip-test" 
                 title="Изведено (ауторско) дело">М101</option>
                 <option value="102" class="tooltip-test" 
                 title="Награда на конкурсу">М102</option>
                 <option value="103" class="tooltip-test" 
                 title="Студија, експертиза">М103</option>
                 <option value="104" class="tooltip-test" 
                 title="Награда на изложби">М104</option>
                 <option value="105" class="tooltip-test" 
                 title="Учешће на изложби">М105</option>
                 <option value="106" class="tooltip-test" 
                 title="Жирирање">М106</option>
                 <option value="107" class="tooltip-test" 
                title="Кустоски рад">М107</option>
           </select>
          </div>
        </div>
    <div class="form-group">
