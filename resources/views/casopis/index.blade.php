...
<section class="wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h3 class="page-header"><i class="fa fa-leanpub"></i>Група резултата М10</h3>
    </div>
  </div>
<div class="row">
    <!-- profile-widget -->
  ...
  <div class="col-lg-12">
    <section class="panel">
      <header class="panel-heading tab-bg-info">
        <ul class="nav nav-tabs">
          <li>
            <a href="#" data-toggle="modal" data-target="#sacuvaj"><i class="fa fa-address-card"></i>
           Унеси податке</a>
          </li>
        </ul>
      </header> 
    ...
    <section class="panel">
      <div class="panel-body bio-graph-info" id="podaci">
        <h1>Монографије, монографске студије, тематски зборници, лексикографске и картографске публикације међународног значаја</h1>
