<!-- forma create modal -->
<div class="modal fade myModal3" role="dialog">
<div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-header">
     ...
     <form class="form-horizontal" role="form" action="{{route('master.update','test')}}" method="post">
      {{method_field('patch')}}
      {{csrf_field()}}
    <div class="modal-body">
      <input type="hidden" id="mas_id" name="mas_id">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          <label class="control-label col-sm-4" for="n">Назив мастер рада:</label>
          <div class="col-sm-8">
         ...
         <div class="form-group">
          <label class="control-label col-sm-4" for="s">Стечени академски назив:</label>
          <div class="col-sm-8">
