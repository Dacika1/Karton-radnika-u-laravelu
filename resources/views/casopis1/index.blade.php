...
<section class="wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h3 class="page-header"><i class="fa fa-newspaper-o"></i>Група резултата М20</h3>
    </div>
  </div>
<div class="row">
    <!-- profile-widget -->
  ...
  <div class="col-lg-12">
    <section class="panel">
      <header class="panel-heading tab-bg-info">
        <ul class="nav nav-tabs">
          <li>
            <a href="#" data-toggle="modal" data-target="#sacuvaj2">
    ...
    <section class="panel">
      <div class="panel-body bio-graph-info" id="podaci">
        <h1>Радови објављени у научним часописима међународног значаја; научна критика; уређивање часописа </h1>
       <table class="table table-striped table-advance table-hover" id="users-table">
        <tbody>
          ...
          @if($article->kljuc>=21 && $article->kljuc<=30)
          <tr>
            <td>{{$no++}}</td>
