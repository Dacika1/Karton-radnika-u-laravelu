...
<section class="wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h3 class="page-header"><i class="fa fa-leanpub"></i>Група резултата М40</h3>
    </div>
  </div>
<div class="row">
    <!-- profile-widget -->
  ...
  <div class="col-lg-12">
    <section class="panel">
      <header class="panel-heading tab-bg-info">
        <ul class="nav nav-tabs">
          <li>
            <a href="#" data-toggle="modal" data-target="#sacuvaj4">
    ...
    <section class="panel">
      <div class="panel-body bio-graph-info" id="podaci">
        <h1>Монографије националног значаја</h1>
     <table class="table table-striped table-advance table-hover" id="users-table">
        <tbody>
          ...
          @if($article->kljuc>=40 && $article->kljuc<=50)
          <tr>
            <td>{{$no++}}</td>
